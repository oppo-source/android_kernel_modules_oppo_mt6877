				  ...
				  IN struct SW_RFB *prSwRfb)
{
	...
	kalMemZero(prBssDesc->ucHePhyCapInfo,
		sizeof(prBssDesc->ucHePhyCapInfo));
#endif
...
#define CHECK_SET_BW40_BW80_5G(_ucHePhyCap,  _ucHePhyCapInfo)		\
{									\
	if (HE_IS_PHY_CAP_CHAN_WIDTH_SET_BW40_BW80_5G(_ucHePhyCap)) {	\
		HE_SET_PHY_CAP_CHAN_WIDTH_SET_BW40_BW80_5G(		\
				_ucHePhyCapInfo);			\
	}								\
}
					CHECK_SET_BW40_BW80_5G(
					    prHeCap->ucHePhyCap,
