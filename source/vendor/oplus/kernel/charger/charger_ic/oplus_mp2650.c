...
int mp2650_otg_enable(void)
{
	...
	mp2650_wireless_set_mps_otg_en_val(MP2650_GPIO_OTG_EN);  //set output 5V vbus
...
int mp2650_otg_disable(void)
{
	...
	mp2650_wireless_set_mps_otg_en_val(MP2650_GPIO_OTG_DIS);  //set disable output 5V vbus
	rc = mp2650_config_interface(REG08_MP2650_ADDRESS,
