...
static ssize_t poff_reason_show(struct kobject *kobj,
	...
	for (pmic_device_index = 0;pmic_device_index<pmic_history_count;pmic_device_index++) {
...
static ssize_t pon_reason_show(struct kobject *kobj,
	...
	for (pmic_device_index = 0;pmic_device_index<pmic_history_count;pmic_device_index++) {
		...
		pon_pon_reason1_reg_vaule = pmic_first_record.pmic_pon_poff_reason[0].pon_reason;
