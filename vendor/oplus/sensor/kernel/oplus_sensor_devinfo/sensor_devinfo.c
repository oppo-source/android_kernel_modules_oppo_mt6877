...
#define GOLD_CCT_3K                 (0x12)
#define GOLD_CCT_6K                 (0x13)
#define GOLD_CCT_FACTOR             (0x14)
#define CCT_TYPE                    (0x15)
#define GOLD_CCT_CHANNELS           (0x16)
#define CCT_GAIN_CALI               (0x17)
...
static int sensor_read_oplus_custom(struct cali_data *data)
{
	...
	DEVINFO_LOG("cct_cali_data [%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d]\n",
		...
		data->cct_cali_data[6], data->cct_cali_data[7], data->cct_cali_data[8],
		data->cct_cali_data[9], data->cct_cali_data[10], data->cct_cali_data[11]);
	return 0;
}
