...
#define oplus_print_ic_err(msg)						\
	chg_err("[IC_ERR][%s]-[%s]-[%d]:%s\n", msg->ic->manu_name,	\
		oplus_chg_ic_err_str(msg->type), msg->sub_type, msg->msg);
...
static inline void oplus_chg_ic_err_trigger_and_clean(struct oplus_chg_ic_dev *ic_dev)
{
	oplus_chg_ic_virq_trigger(ic_dev, OPLUS_IC_VIRQ_ERR);
	oplus_chg_ic_clean_err_msg(ic_dev);
}
