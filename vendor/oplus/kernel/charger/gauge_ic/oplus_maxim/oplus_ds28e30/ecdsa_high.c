...
ucl_type_curve secp256r1 = {(u32*)local_a_p256r1, (u32*)local_b_p256r1, (u32*)local_p_p256r1,
			  (u32*)local_n_p256r1, (u32*)local_xg_p256r1, (u32*)local_yg_p256r1,
			  (u32*)local_inv2_p256r1, (u32*)local_psquare_p256r1,
			  NULL, NULL, SECP256R1_WORDSIZE, SECP256R1_BYTESIZE, SECP256R1};
ucl_type_curve secp192r1 = {(u32*)local_a_p192r1, (u32*)local_b_p192r1, (u32*)local_p_p192r1,
			  (u32*)local_n_p192r1, (u32*)local_xg_p192r1, (u32*)local_yg_p192r1,
			  (u32*)local_inv2_p192r1, (u32*)local_psquare_p192r1,
			  NULL, NULL, SECP192R1_WORDSIZE, SECP192R1_BYTESIZE, SECP192R1};
		...
		u8 *input,  u32 inputlength,  ucl_type_curve *curve_params, u32 configuration)
{
	...
	u8 e[BYTE_LENGTH_64];
	int resu;
	u32 r[SECP521R1_WORDSIZE], e1[SECP521R1_WORDSIZE];
	u32 s[SECP521R1_WORDSIZE], u2[SECP521R1_WORDSIZE+1];    /* SECP521R1_WORDSIZE = 17 */
	u32 x1[SECP521R1_WORDSIZE], y1[SECP521R1_WORDSIZE];
	u32 k[SECP521R1_WORDSIZE], w[SECP521R1_WORDSIZE], D[SECP521R1_WORDSIZE];
...
*/
	...
	ptr = (u8*) & k[0];
	for (i = 0; i < BYTE_LENGTH_32; i += BYTE_LENGTH_2) {
		ptr[i++] = BYTE_VALUE_55;
		ptr[i] = BYTE_VALUE_AA;
	}
#endif
				...
				ucl_type_curve *curve_params, u32 configuration)
{
	...
	u32 E[SECP521R1_WORDSIZE], u1[SECP521R1_WORDSIZE], u2[SECP521R1_WORDSIZE];
	u32 x1[SECP521R1_WORDSIZE], y1[SECP521R1_WORDSIZE], x2[SECP521R1_WORDSIZE];
	u32 y2[SECP521R1_WORDSIZE];
