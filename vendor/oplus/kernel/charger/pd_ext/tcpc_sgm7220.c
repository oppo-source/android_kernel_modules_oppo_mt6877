...
static struct sgm7220_chip *gchip = NULL;
...
void sgm7220_set_typec_sinkonly(void)
{
	...
	if (sgm7220_update_reg(gchip->client, REG_CTL, value, CTR_DISABLE_RD_RP)) {
	...
	if (sgm7220_update_reg(gchip->client, REG_SET, value, SET_MODE_SELECT)) {
