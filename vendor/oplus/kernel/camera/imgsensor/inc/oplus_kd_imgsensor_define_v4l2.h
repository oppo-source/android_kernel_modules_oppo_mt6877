...
#define HIMALAYANMAIN_STEREO_START_ADDR          (0x2B00)
#define HIMALAYANMAIN_STEREO_MT_START_ADDR       (0x31C0)
#define HIMALAYANMAIN_STEREO_MT_105CM_START_ADDR (0x6400)
#define HIMALAYANMAIN_AESYNC_START_ADDR          (0x3880)
#define HIMALAYANFRONT_STEREO_START_ADDR         (0X2200)
#define HIMALAYANFRONT_AESYNC_START_ADDR         (0x3800)
