...
static void kkthtele_update_mode_info(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id)
{
...
static int kkthtele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	kkthtele_update_mode_info(ctx, scenario_id);
	i2c_table_write(ctx,
