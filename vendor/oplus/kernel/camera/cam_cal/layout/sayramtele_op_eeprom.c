...
static unsigned int do_single_lsc_sayramtele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_sayramtele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_sayramtele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_sayramtele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static int do_ois_sayramtele(struct EEPROM_DRV_FD_DATA *pdata, struct ois_cal_data *data);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	// 0x00000006, 0xffffffff, CAM_CAL_SINGLE_EEPROM_DATA,
	0x00000006, 0x01B1012F, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000002, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00001070, 0x0000074C, do_single_lsc_sayramtele},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_sayramtele}, //Start address, block size is useless
		{0x00000001, 0x000017D0, 0x00001028, do_pdaf_sayramtele},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_sayramtele}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT sayramtele_op_eeprom = {
	.name = "sayramtele_op_eeprom",
	...
	.enable_preload = 1,
	.preload_size = 0x8000,
	.parsing_ois_cal_data_from_preload = do_ois_sayramtele,
};
