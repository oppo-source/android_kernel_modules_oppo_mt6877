...
static unsigned int do_single_lsc_kkthuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_kkthuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_kkthuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01AB010A, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_kkthuwide},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_kkthuwide}, //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_kkthuwide}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT kkthuwide_op_eeprom = {
	.name = "kkthuwide_op_eeprom",
