...
#define PFX "CAM_CAL_KNIGHTMFRONT"
...
static unsigned int do_single_lsc_knightmfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_knightmfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_knightmfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01C40055, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_knightmfront},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_knightmfront},  //Start address, block size is useless
		{0x00000000, 0x00000000, 0x00000000, do_stereo_data},
		{0x00000001, 0x00000000, 0x00002000, do_dump_all},
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_knightmfront}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT knightmfront_op_eeprom = {
	.name = "knightmfront_op_eeprom",
