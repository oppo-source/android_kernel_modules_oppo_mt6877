...
static unsigned int do_single_lsc_sayrammain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_sayrammain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_sayrammain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_sayrammain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0148012E, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000002, do_module_version},
		{0x00000001, 0x00000000, 0x00000011, do_part_number},
		{0x00000001, 0x00001070, 0x0000074C, do_single_lsc_sayrammain},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_sayrammain}, //Start address, block size is useless
		{0x00000001, 0x000017D0, 0x0000102E, do_pdaf_sayrammain},
		{0x00000001, 0x00000530, 0x00000012, do_pdaf},
		// {0x00000001, 0x00001250, 0x000003E2, do_pdaf},
		// {0x00000001, 0x00001640, 0x000003E2, do_pdaf},
		// {0x00000001, 0x00001A30, 0x000003E2, do_pdaf},
		// {0x00000001, 0x000039B0, 0x000000C8, do_pdaf},
		// {0x00000001, 0x00003A80, 0x000000C8, do_pdaf},
		// {0x00000001, 0x00003F37, 0x000000C8, do_pdaf},
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000001, 0x00000000, 0x00008000, do_dump_all},
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_sayrammain}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT sayrammain_op_eeprom = {
	.name = "sayrammain_op_eeprom",
