...
static const struct i2c_device_id multi_reg_i2c_id[] = {
    { "wl28681c_konka-pmic", 0},
    {}
};
MODULE_DEVICE_TABLE(i2c, multi_reg_i2c_id);

static struct i2c_driver wl28681c_konka_regulator_driver = {
    .driver = {
        .name = "wl28681c_konka-pmic",
        .owner = THIS_MODULE
...
module_i2c_driver(wl28681c_konka_regulator_driver);
