...
void android_vh_commit_creds_handler(void *unused, const struct task_struct *task, const struct cred *cred)
{
...
int osi_amu_init(struct proc_dir_entry *pde)
{
	...
	if (is_support_amu) {
		...
		REGISTER_TRACE_VH(android_vh_commit_creds, android_vh_commit_creds_handler);
...
int osi_amu_exit(struct proc_dir_entry *pde)
{
	...
	if (is_support_amu) {
		...
		UNREGISTER_TRACE_VH(android_vh_commit_creds, android_vh_commit_creds_handler);
