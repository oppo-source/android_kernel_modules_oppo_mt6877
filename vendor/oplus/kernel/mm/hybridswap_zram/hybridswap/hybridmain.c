...
/**
 * isolate_page_from_lru - a copy of isolate_lru_page
 * Restrictions:
...
/*
 * move_pages_into_lru(), a copy of move_pages_to_lru(), but keep zero ref pages in lru
 * Moves pages from private @list to appropriate LRU list.
 *
 * Returns the number of pages moved to the given lruvec.
 */
static unsigned int move_pages_into_lru(struct lruvec *lruvec,
