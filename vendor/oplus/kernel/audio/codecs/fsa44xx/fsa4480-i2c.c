...
#ifdef CONFIG_OPLUS_MTK_PLATFORM
extern void typec_headset_queue_work(bool plug_flag);
#endif
...
#ifdef CONFIG_OPLUS_MTK_PLATFORM
		if (is_sw_irq) {
			typec_headset_queue_work(false);
		}
#endif
	}
...
#ifdef CONFIG_OPLUS_MTK_PLATFORM
	is_sw_irq = of_property_read_bool(dNode, "is_sw_irq");
#endif
