...
#define AW_SHOW_F0_TO_DSP_F0(f0)	((f0) * (4096)) /* fixed 12bit */

#define AW_DSP_TO_SHOW_T25_F0(val)	((val)/(4096)) /* fiexed 12bit */
...
int aw882xx_dsp_write_air_pressure(struct aw_device *aw_dev, int32_t air_pressure);
