...
#define AW_MSG_ID_ENV_PRESSURE_L	(0x10013D42)
#define AW_MSG_ID_ENV_PRESSURE_R	(0x10013D43)
#define AW_MSG_ID_T25_F0_L		(0x10013D44)
#define AW_MSG_ID_T25_F0_R		(0x10013D45)
...
int aw882xx_dsp_read_cali_f0(struct aw_device *aw_dev, int32_t *cali_f0)
{
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	int32_t read_f0 = 0;
	...
	ret = aw882xx_dsp_read_dsp_msg(aw_dev, msg_id, (char *)&read_f0, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "read cali f0 failed ");
		return ret;
	}
	*cali_f0 = read_f0;
	aw_dev_dbg(aw_dev->dev, "read cali f0 %d done", *cali_f0);
	return ret;
}


int aw882xx_dsp_read_air_pressure(struct aw_device *aw_dev, int32_t *air_pressure)
{
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	int32_t read_val = 0;
	...
	if (aw_dev->channel == AW_DEV_CH_PRI_L ||
			aw_dev->channel == AW_DEV_CH_SEC_L ||
				aw_dev->channel == AW_DEV_CH_TERT_L ||
					aw_dev->channel == AW_DEV_CH_QUAT_L) {
		msg_id = AW_MSG_ID_ENV_PRESSURE_L;
	} else if (aw_dev->channel == AW_DEV_CH_PRI_R ||
			aw_dev->channel == AW_DEV_CH_SEC_R ||
				aw_dev->channel == AW_DEV_CH_TERT_R ||
					aw_dev->channel == AW_DEV_CH_QUAT_R) {
		msg_id = AW_MSG_ID_ENV_PRESSURE_R;
	} else {
		aw_dev_err(aw_dev->dev, "unsupport dev channel");
		return -EINVAL;
	}

	ret = aw882xx_dsp_read_dsp_msg(aw_dev, msg_id, (char *)&read_val, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "read cali air pressure failed ");
		return ret;
	}
	*air_pressure = read_val;;
	aw_dev_dbg(aw_dev->dev, "read cali air pressure done");
	return ret;
}

int aw882xx_dsp_read_t25_f0(struct aw_device *aw_dev, int32_t *t25_f0)
{
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	int32_t read_val = 0;
	...
	if (aw_dev->channel == AW_DEV_CH_PRI_L ||
			aw_dev->channel == AW_DEV_CH_SEC_L ||
				aw_dev->channel == AW_DEV_CH_TERT_L ||
					aw_dev->channel == AW_DEV_CH_QUAT_L) {
		msg_id = AW_MSG_ID_T25_F0_L;
	} else if (aw_dev->channel == AW_DEV_CH_PRI_R ||
			aw_dev->channel == AW_DEV_CH_SEC_R ||
				aw_dev->channel == AW_DEV_CH_TERT_R ||
					aw_dev->channel == AW_DEV_CH_QUAT_R) {
		msg_id = AW_MSG_ID_T25_F0_R;
	} else {
		aw_dev_err(aw_dev->dev, "unsupport dev channel");
		return -EINVAL;
	}
	...
	ret = aw882xx_dsp_read_dsp_msg(aw_dev, msg_id, (char *)&read_val, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "read t25 f0 failed ");
		return ret;
	}
	*t25_f0 = AW_DSP_TO_SHOW_T25_F0(read_val);
	aw_dev_dbg(aw_dev->dev, "read cali t25 f0 : %d done", *t25_f0);
	return ret;
}


int aw882xx_dsp_real_time_f0(struct aw_device *aw_dev, int32_t *real_time_f0)
{
#if 0
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	...
	ret = aw882xx_dsp_read_dsp_msg(aw_dev, msg_id, (char *)&read_val, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "read real time f0 failed ");
		return ret;
	}
	*real_time_f0 = read_val;
	aw_dev_dbg(aw_dev->dev, "read cali real time f0 done");
	return ret;
#endif
	*real_time_f0 = 0;
	aw_dev_err(aw_dev->dev, "unsupport dev channel");
...
int aw882xx_dsp_write_cali_re(struct aw_device *aw_dev, int32_t cali_re)
{
	...
	aw_dev_info(aw_dev->dev, "write cali re done %d \n", cali_re);
	return ret;
}

int aw882xx_dsp_write_cali_f0(struct aw_device *aw_dev, int32_t cali_f0)
{
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	int32_t local_f0 = AW_SHOW_F0_TO_DSP_F0(cali_f0);
	...
	ret = aw882xx_dsp_write_dsp_msg(aw_dev, msg_id, (char *)&local_f0, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "write cali f0 failed ");
		return ret;
	}
	aw_dev_info(aw_dev->dev, "write cali f0 done, set f0 :%d to dsp", local_f0);
	return ret;
}

int aw882xx_dsp_write_air_pressure
						(struct aw_device *aw_dev, int32_t air_pressure)
{
	int ret = 0;
	uint32_t msg_id = -EINVAL;
	int32_t local_air_pressure = air_pressure;
	...
	ret = aw882xx_dsp_write_dsp_msg(aw_dev,
				msg_id, (char *)&local_air_pressure, sizeof(int32_t));
	if (ret) {
		aw_dev_err(aw_dev->dev, "write air pressure failed ");
		return ret;
	}
	aw_dev_info(aw_dev->dev, "write cali f0 done, set air pressure  :%d to dsp",
											local_air_pressure);
	return ret;
}
