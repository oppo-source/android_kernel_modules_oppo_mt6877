...
extern unsigned int vfp_switch_panel_enbale;
/*aod state for level*/
				  ...
				  dcs_write_gce cb, void *handle, unsigned int level)
{
	...
	if (level == 1) {
		...
		lcm_setbrightness_normal[6].para_list[1] = BL_LSB;
		lcm_setbrightness_normal[6].para_list[2] = BL_MSB;
