		...
		enum ENUM_DRV_OWN_SRC eDrvOwnSrc)
{
...
#endif
	uint32_t u4Val1 = 0, u4Val2 = 0, u4Val3 = 0;
	...
	if (fgResult) {
		...
		/* Add PCIe debug log when driver own */
		HAL_MCR_WR(prAdapter, 0x74030168, 0x88CC0100);
		HAL_MCR_WR(prAdapter, 0x74030164, 0x4A474845);
