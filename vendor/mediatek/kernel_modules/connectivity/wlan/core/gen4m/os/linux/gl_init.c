...
//add for project 25922 and 25923, set PALDO 3.5V => 3.3V
...
#if CFG_PMIC_PALDO_CTRL
#define SET_PMIC_PALDO_STR "set_chip pmic 0x00 0xDD 0xC0"
#endif
...
#endif
#if CFG_PMIC_PALDO_CTRL
	char arChipPmicSetCmd[] = SET_PMIC_PALDO_STR;
...
//add for project 25922 and 25923, set PALDO 3.5V => 3.3V
		...
		if (u4PrjName == 25922 || u4PrjName == 25923) {
			DBGLOG(INIT, INFO,
			       "wlanProbe: project %u matched, setting PMIC config\n",
			       u4PrjName);
			i4BytesWritten = priv_driver_set_chip_config(
				arWlanDevInfo[0].prDev, arChipPmicSetCmd, 50);
		}
#else
		i4BytesWritten = priv_driver_set_chip_config(
			arWlanDevInfo[0].prDev, arChipPmicSetCmd, 50);
