...
static void csirx_phyA_dphy_setting(struct seninf_ctx *ctx, void *base, u64 data_rate, bool bw_need_changed)
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
{
	...
	if (!strcasecmp(_seninf_ops->iomem_ver, MT6991_IOMOM_VERSIONS)) {
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
		switch (ctx->csi_param.dphy_ctle) {
			case 1:
				dev_info(ctx->dev, "EQ_SR0 = 0000, dphy_ctle = %d\n", ctx->csi_param.dphy_ctle);
				//1.EQ_SR0 = 0000
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x0);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x0);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
				break;
			case 2:
				dev_info(ctx->dev, "EQ_SR0 = 0001, dphy_ctle = %d\n", ctx->csi_param.dphy_ctle);
				//1.EQ_SR0 = 0001
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x1);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x1);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
			...
			case 3:
				//2.EQ_SR0 = 0011
				dev_info(ctx->dev, "EQ_SR0 = 0011, dphy_ctle = %d\n", ctx->csi_param.dphy_ctle);
			...
			case 4:
				//3.EQ_SR0 = 0111
				dev_info(ctx->dev, "EQ_SR0 = 0111, dphy_ctle = %d\n", ctx->csi_param.dphy_ctle);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x7);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x1);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
				break;
			default:
		...
		switch (ctx->csi_param.dphy_eq_bw) {
			case 1:
				dev_info(ctx->dev, "EQ_BW = 00, dphy_eq_bw = %d\n", ctx->csi_param.dphy_eq_bw);
				//1.EQ_BW = 00
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x00);
				break;
			case 2:
				dev_info(ctx->dev, "EQ_BW = 01, dphy_eq_bw = %d\n", ctx->csi_param.dphy_eq_bw);
				//1.EQ_BW = 01
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x01);
				break;
			case 3:
				dev_info(ctx->dev, "EQ_BW = 11, dphy_eq_bw = %d\n", ctx->csi_param.dphy_eq_bw);
				//1.EQ_BW = 11
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x03);
				break;
			default:
				break;
		}
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
static void csirx_phyA_cphy_setting(struct seninf_ctx *ctx, void *base, u64 data_rate, bool bw_need_changed)
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
{
	u32 en_16bit_mode = (data_rate > 4500000000) ? 0 : 1;
	/* set CDPHY 16/32bit mode */
...
// modify for BrzB change BW 0x03
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
		if(ctx->csi_param.cdr_delay && (ctx->csi_param.cdr_delay < 31))
		{
			dev_info(ctx->dev, "cdr_delay = %d\n", ctx->csi_param.cdr_delay);
			SENINF_BITS(base, CDPHY_RX_ANA_4,
				RG_CSI0_CPHY_T0_CDR_RSTB_CODE, ((ctx->csi_param.cdr_delay & 0b111000) >> 3));
			SENINF_BITS(base, CDPHY_RX_ANA_4,
				RG_CSI0_CPHY_T0_CDR_SEC_EDGE_CODE, (ctx->csi_param.cdr_delay & 0b111));
			SENINF_BITS(base, CDPHY_RX_ANA_6,
				RG_CSI0_CPHY_T0_CDR_CK_DELAY, ctx->csi_param.cdr_delay);
			SENINF_BITS(base, CDPHY_RX_ANA_4,
				RG_CSI0_CPHY_T1_CDR_RSTB_CODE, ((ctx->csi_param.cdr_delay & 0b111000) >> 3));
			SENINF_BITS(base, CDPHY_RX_ANA_4,
				RG_CSI0_CPHY_T1_CDR_SEC_EDGE_CODE, (ctx->csi_param.cdr_delay & 0b111));
			SENINF_BITS(base, CDPHY_RX_ANA_7,
				RG_CSI0_CPHY_T1_CDR_CK_DELAY, ctx->csi_param.cdr_delay);
		}

		switch (ctx->csi_param.cphy_ctle) {
			case 1:
				dev_info(ctx->dev, "EQ_SR0 = 0000, cphy_ctle = %d\n", ctx->csi_param.cphy_ctle);
				//1.EQ_SR0 = 0000
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x0);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x0);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
				break;
			case 2:
				dev_info(ctx->dev, "EQ_SR0 = 0001, cphy_ctle = %d\n", ctx->csi_param.cphy_ctle);
				//1.EQ_SR0 = 0001
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x1);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x1);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
			...
			case 3:
				//2.EQ_SR0 = 0011
				dev_info(ctx->dev, "EQ_SR0 = 0011, cphy_ctle = %d\n", ctx->csi_param.cphy_ctle);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x3);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x1);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
				break;
			case 4:
				//3.EQ_SR0 = 0111
				dev_info(ctx->dev, "EQ_SR0 = 0111, cphy_ctle = %d\n", ctx->csi_param.cphy_ctle);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_SR0, 0x7);
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_DG0_EN, 0x1);
				dev_info(ctx->dev, "CDPHY_RX_ANA_5:(0x%08x)\n", SENINF_READ_REG(base, CDPHY_RX_ANA_5));
				break;
		...
		switch (ctx->csi_param.cphy_eq_bw) {
			case 1:
				dev_info(ctx->dev, "EQ_BW = 00, cphy_eq_bw = %d\n", ctx->csi_param.cphy_eq_bw);
				//1.EQ_BW = 00
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x00);
				break;
			case 2:
				dev_info(ctx->dev, "EQ_BW = 01, cphy_eq_bw = %d\n", ctx->csi_param.cphy_eq_bw);
				//1.EQ_BW = 01
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x01);
				break;
			case 3:
				dev_info(ctx->dev, "EQ_BW = 11, cphy_eq_bw = %d\n", ctx->csi_param.cphy_eq_bw);
				//1.EQ_BW = 11
				SENINF_BITS(base, CDPHY_RX_ANA_5, RG_CSI0_CDPHY_EQ_BW, 0x03);
				break;
			default:
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_dphy_setting(ctx, baseA, data_rate, bw_need_changed);
			csirx_phyA_dphy_setting(ctx, baseB, data_rate, bw_need_changed);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		} else {
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_dphy_setting(ctx, base, data_rate, bw_need_changed);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		}
	} else {
		data_rate = ctx->mipi_pixel_rate * bit_per_pixel;
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_cphy_setting(ctx, baseA, data_rate, bw_need_changed);
			csirx_phyA_cphy_setting(ctx, baseB, data_rate, bw_need_changed);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		} else {
			/* CPHY configuration(A/B same) */
#ifndef OPLUS_FEATURE_CAMERA_COMMON
...
#else /*OPLUS_FEATURE_CAMERA_COMMON*/
			csirx_phyA_cphy_setting(ctx, base, data_rate, false);
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
		}
	}
				...
				struct mtk_cam_seninf_vsync_info *vsync_info)
{
	...
	if (core->refcnt == 0) {
		pr_info("[%s][ERROR] refcnt is = 0 already\n", __func__);
		return;
	}
