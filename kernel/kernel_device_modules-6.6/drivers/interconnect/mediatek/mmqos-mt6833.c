...
/* larb2 */
	...
	DEFINE_MNODE(mdp_wrot0,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_WROT0), 7, true, 0x2, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot1,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_WROT1), 7, true, 0x2, SLAVE_LARB(2)),
...
/* larb4 */
	DEFINE_MNODE(hw_vdec_mc_ext,
		MASTER_LARB_PORT(M4U_PORT_L4_VDEC_MC_EXT), 3, false, 0x2, SLAVE_LARB(4)),
	...
	DEFINE_MNODE(hw_vdec_pp_ext,
		MASTER_LARB_PORT(M4U_PORT_L4_VDEC_PP_EXT), 4, true, 0x2, SLAVE_LARB(4)),
	...
	DEFINE_MNODE(hw_vdec_ufo_enc_ext,
		MASTER_LARB_PORT(M4U_PORT_L4_VDEC_UFO_ENC_EXT), 7, false, 0x2, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_rg_ctrl_dma_ext,
		MASTER_LARB_PORT(M4U_PORT_L4_VDEC_RG_CTRL_DMA_EXT), 4, false, 0x2, SLAVE_LARB(4)),
/* larb7 */
