...
#include "mmqos-mtk.h"
static const struct mtk_node_desc node_descs_mt6781[] = {
	DEFINE_MNODE(common0, SLAVE_COMMON(0), 0, false, 0x0, MMQOS_NO_LINK),
	...
	DEFINE_MNODE(common0_port4, MASTER_COMMON_PORT(0, 4), 0, false, 0x2, SLAVE_COMMON(0)),
...
static const char * const comm_muxes_mt6781[] = { "mm" };
static const char * const comm_icc_path_names_mt6781[] = { "icc-bw" };
static const char * const comm_icc_hrt_path_names_mt6781[] = { "icc-hrt-bw" };
static const char * const larb_icc_path_names_mt6781[] = { "larb0", "larb1", "larb2", NULL,
	"larb4", NULL, NULL, "larb7", NULL, "larb9", NULL, "larb11", NULL, "larb13", "larb14",
	NULL, "larb16", "larb17", NULL, "larb19", "larb20", NULL, NULL, NULL };
static const struct mtk_mmqos_desc mmqos_desc_mt6781 = {
	.nodes = node_descs_mt6781,
	.num_nodes = ARRAY_SIZE(node_descs_mt6781),
	.comm_muxes = comm_muxes_mt6781,
	.comm_icc_path_names = comm_icc_path_names_mt6781,
	.comm_icc_hrt_path_names = comm_icc_hrt_path_names_mt6781,
	.larb_icc_path_names = larb_icc_path_names_mt6781,
	.max_ratio = 40,
	.hrt = {
		.hrt_bw = {1834, 0, 0},
		.hrt_total_bw = 17064, /*Todo: Use DRAMC API 4266*2(channel)*2(io width)*/
		.md_speech_bw = { 1834, 1834},
...
static const struct of_device_id mtk_mmqos_mt6781_of_ids[] = {
	{
		.compatible = "mediatek,mt6781-mmqos",
		.data = &mmqos_desc_mt6781,
	},
	{}
};
MODULE_DEVICE_TABLE(of, mtk_mmqos_mt6781_of_ids);
static struct platform_driver mtk_mmqos_mt6781_driver = {
	.probe = mtk_mmqos_probe,
	.remove = mtk_mmqos_remove,
	.driver = {
		.name = "mtk-mt6781-mmqos",
		.of_match_table = mtk_mmqos_mt6781_of_ids,
	},
};
module_platform_driver(mtk_mmqos_mt6781_driver);
MODULE_LICENSE("GPL");
