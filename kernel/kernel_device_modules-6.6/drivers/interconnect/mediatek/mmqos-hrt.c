...
#if IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6853) || IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6873) \
|| IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6877) || IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6781) \
|| IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6893) || IS_ENABLED(CONFIG_INTERCONNECT_MTK_MMQOS_MT6833)
#define MULTIPLY_W_DRAM_WEIGHT(value) (value)
#else
