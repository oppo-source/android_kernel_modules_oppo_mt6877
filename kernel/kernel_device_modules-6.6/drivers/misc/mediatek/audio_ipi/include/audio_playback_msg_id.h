...
enum {
	...
	AUDIO_DSP_TASK_AURISYS_SET_DL_GAIN,
#endif /* CONFIG_OPLUS_FEATURE_HFCALL */
	AUDIO_DSP_TASK_GET_LATENCY_SUPPORT = 0x400, // offload pause using 0x300
	AUDIO_DSP_TASK_SET_LATENCY_SUPPORT,
	AUDIO_DSP_TASK_GET_LATENCY,
	AUDIO_DSP_TASK_SET_LATENCY,
	AUDIO_DSP_TASK_GET_IRQ_PERIOD,
	AUDIO_DSP_TASK_SET_IRQ_PERIOD,
#if IS_ENABLED(CONFIG_SND_SOC_MTK_AUTO_AUDIO_DSP)
	AUDIO_DSP_TASK_CHANNEL_MAP_CFG,
#endif
};
