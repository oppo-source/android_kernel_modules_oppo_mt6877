...
struct Port {
	...
	AW_U16                 snk_pps_size;
	AW_U32                 snk_pps_vol[12];
	AW_U32                 snk_pps_cur[6];
	AW_U16                 src_pps_size;
	AW_U32                 src_pps_vol[12];
	AW_U32                 src_pps_cur[6];
	AW_U16                 src_pdo_size;
	AW_U32                 src_pdo_vol[7];
	AW_U32                 src_pdo_cur[7];
	AW_U8                  snk_tog_time; /* toggle sink time */
	AW_U8                  src_tog_time; /* toggle source time */
	AW_U8                  cc1_ov_th; /* set cc1 ov threshold */
	AW_U8                  cc2_ov_th; /* set cc2 ov threshold */
	AW_U8                  lpd_tim_set; /* set the LPD sensitivity */
