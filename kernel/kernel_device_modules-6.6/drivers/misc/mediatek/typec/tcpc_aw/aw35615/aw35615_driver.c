...
/* USD: get cc status form ic by hongmin.zhou 20250228 start*/
	*cc1 = chip->tcpc->typec_remote_cc[0];
	*cc2 = chip->tcpc->typec_remote_cc[1];
	AW_LOG("cc1=%d, cc2=%d\n",*cc1 ,*cc2);
/* USD: get cc status form ic by hongmin.zhou 20250228 end*/
