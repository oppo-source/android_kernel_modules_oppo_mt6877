...
/* sec */
#define R_SEC_CTRL                      (vcpreg.cfg_sec_ctrl)
#define R_SEC_CTRL_2                    (vcpreg.cfg_sec_ctrl + 0x0004)
#define R_AHB_BUS_SEC_CTRL              (vcpreg.cfg_sec_ctrl + 0x0010)
#define R_AHB_BUS_PROT_CTRL             (vcpreg.cfg_sec_ctrl + 0x0014)
#define R_GPR0_CFGREG_SEC               (vcpreg.cfg_sec)
#define R_GPR1_CFGREG_SEC               (vcpreg.cfg_sec + 0x0004)
#define R_GPR2_CFGREG_SEC               (vcpreg.cfg_sec + 0x0008)
	#define MMUP_AP_SUSPEND             (1U << 0)
	#define MMUP_WARM_BOOT              (1U << 1)
#define R_GPR3_CFGREG_SEC               (vcpreg.cfg_sec + 0x000C)
	#define VCP_AP_SUSPEND              (1U << 0)
	#define VCP_WARM_BOOT               (1U << 1)
#define R_SEC_DOMAIN                    (vcpreg.cfg_sec + 0x0040)
#define R_SEC_DOMAIN_MMPC               (vcpreg.cfg_sec + 0x0044)
#define R_DYN_SECURE                    (vcpreg.cfg_sec + 0x0190)
#define R_DYN_SECURE_TH1                (vcpreg.cfg_sec + 0x0194)
#define R_NS_SECURE_ADDR0               (vcpreg.cfg_sec + 0x01A0)
#define R_NS_SECURE_ADDR1               (vcpreg.cfg_sec + 0x01A4)
#define R_NS_SECURE_ADDR2               (vcpreg.cfg_sec + 0x01A8)
#define R_NS_SECURE_ADDR3               (vcpreg.cfg_sec + 0x01AC)
#define R_SECURE_DOMAIN_EN0             (vcpreg.cfg_sec + 0x01C0)
#define R_SECURE_DOMAIN_EN1             (vcpreg.cfg_sec + 0x01C4)
#define R_NSECURE_DOMAIN_EN0            (vcpreg.cfg_sec + 0x01C8)
#define R_NSECURE_DOMAIN_EN1            (vcpreg.cfg_sec + 0x01CC)
#define R_SECURE_DOMAIN7_0              (vcpreg.cfg_sec + 0x01D0)
#define R_SECURE_DOMAIN15_8             (vcpreg.cfg_sec + 0x01D4)
#define R_NSECURE_DOMAIN7_0             (vcpreg.cfg_sec + 0x01F0)
#define R_NSECURE_DOMAIN15_8            (vcpreg.cfg_sec + 0x01F4)
#define R_SECURE_ADDR0                  (vcpreg.cfg_sec + 0x0210)
#define R_SECURE_ADDR1                  (vcpreg.cfg_sec + 0x0214)
#define R_SECURE_ADDR2                  (vcpreg.cfg_sec + 0x0218)
#define R_SECURE_ADDR3                  (vcpreg.cfg_sec + 0x021C)
#define R_NSECURE_ADDR0                 (vcpreg.cfg_sec + 0x0310)
#define R_NSECURE_ADDR1                 (vcpreg.cfg_sec + 0x0314)
#define R_NSECURE_ADDR2                 (vcpreg.cfg_sec + 0x0318)
#define R_NSECURE_ADDR3                 (vcpreg.cfg_sec + 0x031C)
