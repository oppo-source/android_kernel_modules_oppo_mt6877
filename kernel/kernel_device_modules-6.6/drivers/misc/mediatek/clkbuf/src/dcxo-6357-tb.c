...
#define XO_CDAC_FPM_ADDR        (DCXO_CW04)
#define XO_CDAC_FPM_MASK        (0xFF)
#define XO_CDAC_FPM_SHIFT       (0)
#define XO_AAC_FPM_SWEN_ADDR    (DCXO_CW09)
#define XO_AAC_FPM_SWEN_MASK    (0x1)
#define XO_AAC_FPM_SWEN_SHIFT   (14)
...
struct plat_xodata mt6357_tb_data = {
	.xo_buf_t = mt6357_xo_bufs,
	.debug_regs = mt6357_debug_regs,
	.common_regs = &mt6357_com_regs,
};
