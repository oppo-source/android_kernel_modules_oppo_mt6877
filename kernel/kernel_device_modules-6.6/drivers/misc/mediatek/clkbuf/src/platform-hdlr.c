...
static struct match_platform mt8786_match = {
	.name = "mediatek,mt8786-clkbuf",
	.init = &mt8xxx_init,
};

static struct match_platform mt8791_match = {
	.name = "mediatek,mt8791-clkbuf",
	.init = &mt8xxx_init,
};
...
static struct match_platform mt8793_match = {
	.name = "mediatek,mt8793-clkbuf",
	.init = &mt8xxx_init,
};

static struct match_platform mt8768_match = {
	.name = "mediatek,mt8768-clkbuf",
	.init = &mt8xxx_init,
};

static struct match_platform mt8766_match = {
	.name = "mediatek,mt8766-clkbuf",
	.init = &mt8xxx_init,
};

static struct match_platform mt8799_match = {
	.name = "mediatek,mt8799-clkbuf",
	.init = &mt8xxx_init,
};

static struct match_platform mt8788_match = {
	.name = "mediatek,mt8788-clkbuf",
	.init = &mt8xxx_init,
};
