			...
			u4J++) {
				...
				ncache_mem_list[u4I].u4VCodecThreadNum =
					...
					for (u4K = 0;
						 ...
						 * WARNING:BRACES:
						 */
						ncache_mem_list[u4I].u4VCodecThreadID[u4K] =
							0xffffffff;
					}
					ncache_mem_list[u4I].ulKVA = -1L;
					ncache_mem_list[u4I].ulKPA = -1L;
