...
#include "mtk_cm_mgr_platform_data_mt8788.h"
...
__weak void cm_mgr_update_dram_by_cpu_opp(int cpu_opp) {};
...
EXPORT_SYMBOL(cm_mgr_perf_set_status);
...
static void __exit cm_mgr_module_exit(void)
{

}

module_init(cm_mgr_module_init)
module_exit(cm_mgr_module_exit)

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("MTK CM MGR");
