...
#include "mtk_cm_mgr_platform_mt8788.h"
#include "mtk_cm_mgr_platform_reg_mt8788.h"
...
//__weak int dvfsrc_get_bw(int type) {return 0; };
//__weak int dvfsrc_get_emi_bw(int type) {return 0; };
