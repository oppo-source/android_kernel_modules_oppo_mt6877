...
#define AF_DRVNAME "GT9772AF_MADRID_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		SDC_C_ret = s4AF_WriteReg(0, 0x06, 0x84); //SDC enable and SDC_C set
		PRESC_ret = s4AF_WriteReg(0, 0x07, 0x01); //PRESC[1:0]=01
		SDTC_ret = s4AF_WriteReg(0, 0x08, 0x58); //SDTC[6:0]=1001001
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AF_MADRID_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9772AF_MADRID_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int GT9772AF_MADRID_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9772AF_MADRID_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AF_MADRID_GetFileName(unsigned char *pFileName)
{
