 ...
 * The default opp is at the minimum performance,
...
#define VPU_IOCTL_VBUF_INFO         _IOWR(VPU_MAGICNO,  51, struct vbuf_info)
#define VPU_IOCTL_VBUF_ALLOC        _IOWR(VPU_MAGICNO,  52, struct vbuf_alloc)
#define VPU_IOCTL_VBUF_FREE         _IOWR(VPU_MAGICNO,  53, struct vbuf_free)
#define VPU_IOCTL_VBUF_SYNC         _IOWR(VPU_MAGICNO,  54, struct vbuf_sync)
