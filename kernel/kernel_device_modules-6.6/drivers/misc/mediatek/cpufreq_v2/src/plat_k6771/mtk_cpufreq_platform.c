...
int __weak sync_dcm_set_mp0_freq(unsigned int mhz)
{
	return 0;
}

int __weak sync_dcm_set_mp1_freq(unsigned int mhz)
{
	return 0;
}

int __weak sync_dcm_set_mp2_freq(unsigned int mhz)
{
	return 0;
}

int __weak sync_dcm_set_cci_freq(unsigned int mhz)
{
	return 0;
}
...
{
	regulator_proc11 = devm_regulator_get_optional(&pdev->dev, "vproc11");
	regulator_proc12 = devm_regulator_get_optional(&pdev->dev, "vproc12");
	regulator_sram11 = devm_regulator_get_optional(&pdev->dev, "vsram_proc11");
	regulator_sram12 = devm_regulator_get_optional(&pdev->dev, "vsram_proc12");
...
void ppm_register_cb(void)
{
	...
	ppm_cpufreq_get_cpu_level_register(mt_cpufreq_get_cpu_level);
