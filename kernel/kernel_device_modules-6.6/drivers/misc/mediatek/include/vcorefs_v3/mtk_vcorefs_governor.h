...
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6758)
/* note it is 3 OPP only */
#define LATE_INIT_OPP           (NUM_OPP - 1)
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6763)
#define LATE_INIT_OPP           (NUM_OPP - 1)
 ...
 */
#define PMIC_VCORE_ADDR         2191

#if IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6799)          /* PMIC MT6335 */
#define VCORE_BASE_UV           400000
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6763)        /* PMIC MT6356 */
#define VCORE_BASE_UV           500000
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6739)        /* PMIC MT6357 */
#define VCORE_BASE_UV           518750
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6759) || IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6758)
	|| IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6775)
#define VCORE_BASE_UV           406250
#elif IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT8788)        /* PMIC MT6358 */
#define VCORE_BASE_UV           500000
#else
