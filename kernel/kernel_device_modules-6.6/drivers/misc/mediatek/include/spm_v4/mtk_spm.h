...
enum {
...
#if IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT6739) || IS_ENABLED(CONFIG_MTK_PLAT_POWER_MT8788)
	SPM_ARGS_SPMFW_INIT,
#endif
	SPM_ARGS_SUSPEND,
	...
	SPM_ARGS_PCM_WDT,
	SPM_ARGS_REG_EDGE_TRIGGER_IRQ,
	SPM_ARGS_SET_WAKEUP_SOURCES,
	SPM_ARGS_IRQ_BACKUP,
	SPM_ARGS_IRQ_RESTORE,
	SPM_ARGS_NUM,
};
