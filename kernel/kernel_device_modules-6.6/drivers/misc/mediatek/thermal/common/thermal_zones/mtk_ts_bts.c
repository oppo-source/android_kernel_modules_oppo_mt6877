...
struct file *file, const char __user *buffer, size_t count, loff_t *data)
{
	...
	if (sscanf
		...
		&& (ptr_mtktsbts_parm_data->adc_channel <= 11))
			 ...
			 */
			if (is_project(24713) || is_project(24714) || is_project(24715) || is_project(24728) || is_project(25706) || is_project(25707) || is_project(25708) || is_project(25727) || is_project(25728) || is_project(25729)) {
