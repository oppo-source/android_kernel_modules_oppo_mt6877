...
static int get_hw_AP_temp(void)
{
	...
	if (is_project(24713) || is_project(24714) || is_project(24715) || is_project(24728) || is_project(24700) || is_project(24701) || is_project(24702) || is_project(24709) || is_project(25706) || is_project(25707) || is_project(25708) || is_project(25727) || is_project(25728) || is_project(25729)) {
