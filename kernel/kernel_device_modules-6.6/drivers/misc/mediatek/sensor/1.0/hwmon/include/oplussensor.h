...
#define SENSOR_TYPE_FLAT_DETECT                        94
#define SENSOR_TYPE_CHOP_DETECT                        95
...
#define ID_FLAT_DETECT          (ID_OPLUS_BASE + SENSOR_TYPE_FLAT_DETECT- 1)
#define ID_CHOP_DETECT          (ID_OPLUS_BASE + SENSOR_TYPE_CHOP_DETECT- 1)
...
union oplus_data_unit_t {
    ...
    flat_detect_event_t flat_detect_data_t;
    chop_detect_event_t chop_detect_data_t;
