...
#define MTK_LP_SYSFS_HAS_ENTRY		(0)
...
extern int mtk_lp_sysfs_entry_create_plat(const char *name,
		int mode, struct mtk_lp_sysfs_handle *parent,
		struct mtk_lp_sysfs_handle *handle);

extern int mtk_lp_sysfs_entry_node_add_plat(const char *name,
		int mode, const struct mtk_lp_sysfs_op *op,
		struct mtk_lp_sysfs_handle *parent,
		struct mtk_lp_sysfs_handle *handle);

extern int mtk_lp_sysfs_entry_node_remove_plat(
		struct mtk_lp_sysfs_handle *node);

extern int mtk_lp_sysfs_entry_group_create_plat(const char *name,
		int mode, struct mtk_lp_sysfs_group *_group,
		struct mtk_lp_sysfs_handle *parent,
		struct mtk_lp_sysfs_handle *handle);
