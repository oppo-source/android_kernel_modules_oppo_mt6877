...
#define PFX "S5KGM2SPGMS_camera_sensor"
...
#define DEVICE_VERSION_S5KGM2SPGMS    "s5kgm2spgms"
...
{  // Preview mode setting
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    ...
    0x01, 0x30, 0xFA0, 0xBB8, 0x03, 0x00, 0x0000, 0x0000},
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == S5KGM2SPGMS_SENSOR_ID)
				&& (data_base == 0x1640)
				&& (data_length == 1561)) {
 ...
 static int get_board_id(void)
{
	...
	// {
		...
		// printk("[s5kgm2spgms]MIN_VOLTAGE = %d,MAX_VOLTAGE = %d\n",MIN_VOLTAGE,MAX_VOLTAGE);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 1;
			...
			{
				get_board_id();
				printk("[s5kgm2spgms]CheckGmsFlag = %d\n",CheckGmsFlag);
				if(CheckGmsFlag == 1)
				{
				#ifdef VENDOR_EDIT
				...
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_b", DEVICE_VERSION_S5KGM2SPGMS, module_id);
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			s5kgm2spgms_read_otp_pdaf_data((kal_uint16)(*feature_data),
