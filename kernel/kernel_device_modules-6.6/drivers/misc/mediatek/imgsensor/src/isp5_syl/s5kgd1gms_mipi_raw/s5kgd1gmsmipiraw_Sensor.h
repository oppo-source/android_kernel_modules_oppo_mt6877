...
struct imgsensor_info_struct {
	...
	kal_uint32 cap_delay_frame;						//enter capture delay frame num
	kal_uint32 pre_delay_frame;						//enter preview delay frame num
	kal_uint32 video_delay_frame;					//enter video delay frame num
	kal_uint32 hs_video_delay_frame;					//enter high speed video  delay frame num
