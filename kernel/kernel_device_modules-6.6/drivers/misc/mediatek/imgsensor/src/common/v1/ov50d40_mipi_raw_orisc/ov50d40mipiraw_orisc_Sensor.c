...
#include "ov50d40mipiraw_orisc_Sensor.h"
#include "ov50d40_Sensor_orisc_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_ORISC,
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[4] = {
    /* preview mode setting */
    {
        ...
        0x00, 0x2b, 0x1000, 0x0C00, 0x00, 0x00, 0x0000, 0x0000,//4080*3072
    ...
    {
        0x02, 0x0a, 0x0000, 0x0008, 0x40, 0x00,
        0x00, 0x2b, 0x1000, 0x0900, 0x00, 0x00, 0x0000, 0x0000, //4080*2296
        0x01, 0x2B, 0x04D8, 0x023C, 0x03, 0x00, 0x0000, 0x0000 //992x572
    },
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_cap = {
    ...
    .i4BlockNumX = 248,
    .i4BlockNumY = 190,
    .i4Crop = { {0, 0}, {8, 0}, {8, 388}, {0, 0}, {8, 388},
        {8, 0}, {8, 0} ,{128, 456} },
};
...
{
    char pusendcmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
    iReadRegI2CTiming(pusendcmd, 2, (u8 *)table, size, OV50D40_EEPROM_I2C_ADDR, imgsensor_info.i2c_speed);
}
...
static kal_uint16 read_ov50d40_eeprom_module(kal_uint32 addr)
{
    ...
    iReadRegI2CTiming(pusendcmd, 2, (u8 *) &get_byte, 1, OV50D40_EEPROM_I2C_ADDR, imgsensor_info.i2c_speed);
    return get_byte;
}
...
static void read_ov50d40_module_data(void)
{
    // length   : 64
    // QR       : [8 ~ 26]
    // vcm      : [40 ~ 41]
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == OV50D40_SENSOR_ID) {
                //hardwareinfo_set_prop(HARDWARE_BACK_CAM, "OV50d40_mipi_raw_oris");
                //hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "omnivision");
