...
struct IMGSENSOR_SENSOR_LIST
    gimgsensor_sensor_list_23689[MAX_NUM_OF_SUPPORT_SENSOR] = {
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_23689[] = {
    {
        IMGSENSOR_SENSOR_IDX_MAIN,
        IMGSENSOR_I2C_DEV_0,
        {
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_23689[] = {
#if defined(IMX890_MIPI_RAW23689)
    {
...
void oplus_imgsensor_hwcfg(void)
{
    if (is_project(22083) || is_project(22291) || is_project(22292)) {
         ...
         oplus_gimgsensor_sensor_list = gimgsensor_sensor_list_23689;
         oplus_imgsensor_custom_config = imgsensor_custom_config_23689;
         oplus_sensor_power_sequence = sensor_power_sequence_23689;
