...
static int get_devinfo(void)
{
	...
	/* FTPGM */
		...
		efuse_get_value_by_offset(DEVINFO_IDX_2, sizeof(__u32), &val[2]);
		efuse_get_value_by_offset(DEVINFO_IDX_3, sizeof(__u32), &val[3]);
		efuse_get_value_by_offset(DEVINFO_IDX_4, sizeof(__u32), &val[4]);
		efuse_get_value_by_offset(DEVINFO_IDX_5, sizeof(__u32), &val[5]);
		efuse_get_value_by_offset(DEVINFO_IDX_6, sizeof(__u32), &val[6]);
		efuse_get_value_by_offset(DEVINFO_IDX_7, sizeof(__u32), &val[7]);
		efuse_get_value_by_offset(DEVINFO_IDX_8, sizeof(__u32), &val[8]);
		efuse_get_value_by_offset(DEVINFO_IDX_9, sizeof(__u32), &val[9]);
		efuse_get_value_by_offset(DEVINFO_IDX_10, sizeof(__u32), &val[10]);
		efuse_get_value_by_offset(DEVINFO_IDX_11, sizeof(__u32), &val[11]);
		efuse_get_value_by_offset(DEVINFO_IDX_12, sizeof(__u32), &val[12]);
		efuse_get_value_by_offset(DEVINFO_IDX_13, sizeof(__u32), &val[13]);
		efuse_get_value_by_offset(DEVINFO_IDX_14, sizeof(__u32), &val[14]);
		efuse_get_value_by_offset(DEVINFO_IDX_15, sizeof(__u32), &val[15]);
		efuse_get_value_by_offset(DEVINFO_IDX_16, sizeof(__u32), &val[16]);
		efuse_get_value_by_offset(DEVINFO_IDX_17, sizeof(__u32), &val[17]);
		efuse_get_value_by_offset(DEVINFO_IDX_21, sizeof(__u32), &val[18]);
		efuse_get_value_by_offset(DEVINFO_IDX_22, sizeof(__u32), &val[19]);
		efuse_get_value_by_offset(DEVINFO_IDX_23, sizeof(__u32), &val[20]);
...
static int eem_hrid_proc_show(struct seq_file *m, void *v)
{
	...
	FUNC_ENTER(FUNC_LV_HELP);
	for (i = 0; i < 4; i++){
		efuse_get_value_by_offset((DEVINFO_HRID_0 + i * 4),sizeof(__u32), &val);
...
static int eem_efuse_proc_show(struct seq_file *m, void *v)
{
	...
	FUNC_ENTER(FUNC_LV_HELP);
	for (i = 0; i < 25; i++){
		efuse_get_value_by_offset((DEVINFO_IDX_0 + i * 4), sizeof(__u32), &tmp);
		seq_printf(m, "%s[PTP_DUMP] ORIG_RES%d: 0x%08X\n", EEM_TAG, i, tmp);
	}

	efuse_get_value_by_offset((DEVINFO_IDX_25), sizeof(__u32), &tmp);
	seq_printf(m, "%s[PTP_DUMP] ORIG_RES%d: 0x%08X\n", EEM_TAG, 25, tmp);

	efuse_get_value_by_offset((DEVINFO_IDX_27), sizeof(__u32), &tmp);
	seq_printf(m, "%s[PTP_DUMP] ORIG_RES%d: 0x%08X\n", EEM_TAG, 27, tmp);
