...
static int lcm_setbacklight_cmdq(void *dsi, dcs_write_gce cb, void *handle, unsigned int bl_level)
{
	...
	printk("[lcd_info]%s: p_7_1 bl_level:%d, mapping value = %d\n", __func__, bl_level, backlight_mapping_buf[bl_level]);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "X25N16_A0028", "P_7");
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "panel_x25n16_p_7_a0028_dsi_vdo",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel_x25n16_p_7_a0028_dsi_vdo",
		.owner = THIS_MODULE,
