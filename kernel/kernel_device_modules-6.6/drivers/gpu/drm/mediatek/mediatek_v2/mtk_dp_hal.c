...
void mhal_DPTx_hw_phy_set_param(struct mtk_dp *mtk_dp, BYTE MAX_LANECOUNT)
{
	...
	DPTXMSG("xmly use case 1: phy_setting%d\n", mtk_dp-> phy_setting);
	switch (mtk_dp-> phy_setting)
	{
		case 1:
		// SW Patch 4.4
			msPhyWrite4Byte(mtk_dp, 0x1138,0x110e0c08);
			msPhyWrite4Byte(mtk_dp, 0x1238,0x110e0c08);
			msPhyWrite4Byte(mtk_dp, 0x1338,0x110e0c08);
			msPhyWrite4Byte(mtk_dp, 0x1438,0x110e0c08);

			msPhyWrite4Byte(mtk_dp, 0x113C,0x1112110c); //
			msPhyWrite4Byte(mtk_dp, 0x123C,0x1112110c);
			msPhyWrite4Byte(mtk_dp, 0x133C,0x1112110c);
			msPhyWrite4Byte(mtk_dp, 0x143C,0x1112110c);

			msPhyWrite4Byte(mtk_dp, 0x1140,0x00001814);
			msPhyWrite4Byte(mtk_dp, 0x1240,0x00001814);
			msPhyWrite4Byte(mtk_dp, 0x1340,0x00001814);
			msPhyWrite4Byte(mtk_dp, 0x1440,0x00001814);
			...
			msPhyWrite4Byte(mtk_dp, 0x1148,0x01060300);//
			msPhyWrite4Byte(mtk_dp, 0x1248,0x01060300);
			msPhyWrite4Byte(mtk_dp, 0x1348,0x01060300);
			msPhyWrite4Byte(mtk_dp, 0x1448,0x01060300);

			msPhyWrite4Byte(mtk_dp, 0x114C,0x00000004);
			msPhyWrite4Byte(mtk_dp, 0x124C,0x00000004);
			msPhyWrite4Byte(mtk_dp, 0x134C,0x00000004);
			msPhyWrite4Byte(mtk_dp, 0x144C,0x00000004);
			break;
		case 2:
		// SW Patch 4.4
			msPhyWrite4Byte(mtk_dp, 0x1138,0x110e0c08);
			...
			msPhyWrite4Byte(mtk_dp, 0x113C,0x1012110c);//
			msPhyWrite4Byte(mtk_dp, 0x123C,0x1012110c);
			msPhyWrite4Byte(mtk_dp, 0x133C,0x1012110c);
			msPhyWrite4Byte(mtk_dp, 0x143C,0x1012110c);
			...
			msPhyWrite4Byte(mtk_dp, 0x1148,0x02060300);//
			msPhyWrite4Byte(mtk_dp, 0x1248,0x02060300);
			msPhyWrite4Byte(mtk_dp, 0x1348,0x02060300);
			msPhyWrite4Byte(mtk_dp, 0x1448,0x02060300);
