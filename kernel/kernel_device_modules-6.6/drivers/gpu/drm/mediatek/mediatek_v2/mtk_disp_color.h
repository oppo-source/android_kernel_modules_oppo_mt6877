...
#define SWREG_MDP_TDSHP_BASE_ADDRESS    (DISP_COLOR_SWREG_COLOR_BASE + 0x0002)
...
#define SWREG_C3D9_BASE_ADDRESS         (DISP_COLOR_SWREG_COLOR_BASE + 0x0013)
#define SWREG_C3D17_BASE_ADDRESS        (DISP_COLOR_SWREG_COLOR_BASE + 0x0014)
#define SWREG_DITHER_BASE_ADDRESS       (DISP_COLOR_SWREG_COLOR_BASE + 0x0015)
