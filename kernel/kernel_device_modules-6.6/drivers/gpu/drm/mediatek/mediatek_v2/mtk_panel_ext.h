...
//Settings for LFR Function:
	...
	*/
	...
	/* wait for the video panel delay to take effect before hbm */
	unsigned int oplus_ofp_video_hbm_delay;
  ...
  /*#endif*/
	...
	unsigned int oplus_lcd_display_off_esdcheck;
...
struct mtk_panel_funcs {
	...
	int (*oplus_set_aod_light_mode)(void *dsi_drv, dcs_write_gce_pack cb,
		void *handle, unsigned int mode);
	int (*oplus_set_aod_light_mode_ramless)(void *dsi_drv, dcs_write_gce cb,
                void *handle, unsigned int mode);
	...
	int (*oplus_doze_enable_ramless)(struct drm_panel *panel, void *dsi_drv, dcs_write_gce cb, void *handle);
	int (*oplus_doze_disable)(struct drm_panel *panel, void *dsi_drv, dcs_write_gce_pack cb, void *handle);
	int (*oplus_doze_disable_ramless)(struct drm_panel *panel, void *dsi_drv, dcs_write_gce cb, void *handle);
