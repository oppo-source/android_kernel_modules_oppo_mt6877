...
#ifndef OPLUS_FEATURE_CHG_BASIC
	if ((i2c->ch_offset_i2c != i2c->i2c_offset_scp) &&
		(mtk_i2c_read_shadow(i2c, OFFSET_DMA_FSM_DEBUG) & I2C_I3C_EN)) {
		debugctrl_reg = mtk_i2c_read_shadow(i2c, OFFSET_DEBUGCTRL);
		mtk_i2c_write_shadow(i2c, debugctrl_reg & (~I2C_DEBUGCTRL_BUS), OFFSET_DEBUGCTRL);
	}
#endif
...
#ifdef OPLUS_FEATURE_CHG_BASIC
//MTK case：ALPS09616680
	if (i2c->support_bq27z561){
		mtk_i2c_writew(i2c, 0xff01, OFFSET_EXT_CONF);
		mtk_i2c_writew(i2c, 0x1f, OFFSET_CLOCK_DIV);
		mtk_i2c_writew(i2c, 0x404, OFFSET_TIMING);
		mtk_i2c_writew(i2c, 0x104, OFFSET_LTIMING);
	}
#endif
...
#ifdef OPLUS_FEATURE_CHG_BASIC
	i2c->support_bq27z561 = of_property_read_bool(np, "oplus,support_bq27z561");
	dev_info(i2c->dev, "support_bq27z561=%d\n", i2c->support_bq27z561);
#endif
