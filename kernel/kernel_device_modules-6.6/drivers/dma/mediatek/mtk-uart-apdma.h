...
#define KERNEL_mtk_uart_apdma_record_dbg mtk_uart_apdma_record_dbg
...
#define KERNEL_mtk_uart_apdma_debug_dump mtk_uart_apdma_debug_dump
#endif
#ifdef CONFIG_OPLUS_POGOPIN_FUNCTION
#define KERNEL_mtk_uart_set_kb_port_status  mtk_uart_set_kb_port_status
#endif
...
#ifdef CONFIG_OPLUS_POGOPIN_FUNCTION
void mtk_uart_set_kb_port_status(struct dma_chan *chan, bool status);
#endif
