...
/*
 * mt6991-afe-common.h  --  Mediatek 6991 audio driver definitions
 *
...
enum {
	...
	MT6991_MEMIF_HDMI,
	MT6991_MEMIF_NUM,
	MT6991_DAI_ADDA = MT6991_MEMIF_NUM,
	MT6991_DAI_ADDA_CH34,
	...
	MT6991_DAI_HW_GAIN_1,
	MT6991_DAI_HW_GAIN_2,
	MT6991_DAI_HW_GAIN_3,
	MT6991_DAI_SRC_0,
	MT6991_DAI_SRC_1,
	MT6991_DAI_SRC_2,
	MT6991_DAI_SRC_3,
	...
	MT6991_DAI_HOSTLESS_BT,
	MT6991_DAI_HOSTLESS_SPH_ECHO_REF,
	MT6991_DAI_HOSTLESS_SPK_INIT,
	MT6991_DAI_HOSTLESS_IMPEDANCE,
	MT6991_DAI_HOSTLESS_SRC_0,
	MT6991_DAI_HOSTLESS_SRC_1,
	MT6991_DAI_HOSTLESS_SRC_2,
	MT6991_DAI_HOSTLESS_SRC_3,
	MT6991_DAI_HOSTLESS_HW_SRC_0_OUT,
	MT6991_DAI_HOSTLESS_HW_SRC_0_IN,
	MT6991_DAI_HOSTLESS_HW_SRC_1_OUT,
	MT6991_DAI_HOSTLESS_HW_SRC_1_IN,
	MT6991_DAI_HOSTLESS_HW_SRC_2_OUT,
	MT6991_DAI_HOSTLESS_HW_SRC_2_IN,
	MT6991_DAI_HOSTLESS_SRC_BARGEIN,
	MT6991_DAI_HOSTLESS_UL1,
	MT6991_DAI_HOSTLESS_UL2,
	MT6991_DAI_HOSTLESS_UL3,
	MT6991_DAI_HOSTLESS_UL4,
	MT6991_DAI_HOSTLESS_DSP_DL,
#if IS_ENABLED(CONFIG_SND_SOC_MTK_AUTO_AUDIO_DSP)
	MT6991_DAI_HOSTLESS_UL5,
	MT6991_DAI_HOSTLESS_UL6,
#endif
	MT6991_DAI_NUM,
...
#define MT6991_FAST_MEMIF MT6991_MEMIF_DL2
#define MT6991_DEEP_MEMIF MT6991_MEMIF_DL3
#define MT6991_VOIP_MEMIF MT6991_MEMIF_DL1
#define MT6991_MMAP_DL_MEMIF MT6991_MEMIF_DL4
#define MT6991_MMAP_UL_MEMIF MT6991_MEMIF_VUL2
#define MT6991_BARGE_IN_MEMIF MT6991_MEMIF_VUL_CM0

// adsp define
#define MT6991_DSP_PRIMARY_MEMIF MT6991_MEMIF_DL0
#define MT6991_DSP_DEEPBUFFER_MEMIF MT6991_MEMIF_DL3
#define MT6991_DSP_VOIP_MEMIF MT6991_MEMIF_DL1
#define MT6991_DSP_PLAYBACKDL_MEMIF MT6991_MEMIF_DL4
#define MT6991_DSP_PLAYBACKUL_MEMIF MT6991_MEMIF_VUL4
...
enum {
	...
	MT6991_IRQ_25,
	MT6991_IRQ_26,
	MT6991_IRQ_31,  /* used only for TDM */
	MT6991_IRQ_NUM,
};
/* update irq ID (= enum) from AFE_IRQ_MCU_STATUS */
enum {
	MT6991_CUS_IRQ_TDM = 0,  /* used only for TDM */
	MT6991_CUS_IRQ_NUM,
};
...
struct mt6991_afe_private {
	...
	int voip_rx_state;
	/* xrun assert */
	int xrun_assert[MT6991_MEMIF_NUM];

	/* dai */
	bool dai_on[MT6991_DAI_NUM];
	void *dai_priv[MT6991_DAI_NUM];
...
int mt6991_dai_hw_gain_register(struct mtk_base_afe *afe);
int mt6991_dai_src_register(struct mtk_base_afe *afe);
int mt6991_dai_pcm_register(struct mtk_base_afe *afe);
int mt6991_dai_tdm_register(struct mtk_base_afe *afe);

int mt6991_dai_hostless_register(struct mtk_base_afe *afe);

int mt6991_add_misc_control(struct snd_soc_component *component);
