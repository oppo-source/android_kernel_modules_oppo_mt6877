...
static const struct snd_pcm_hardware mt6991_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"Hostless LPBK UL", NULL, "ADDA_CH56_UL_Mux"},
	...
	{"PCM_1_PB_CH1", "ADDA_UL_CH4", "Hostless Speech DL"},
	{"PCM_1_PB_CH1", "ADDA_UL_CH5", "Hostless Speech DL"},
	{"PCM_1_PB_CH1", "ADDA_UL_CH6", "Hostless Speech DL"},
	...
	{"PCM_1_PB_CH2", "ADDA_UL_CH4", "Hostless Speech DL"},
	{"PCM_1_PB_CH2", "ADDA_UL_CH5", "Hostless Speech DL"},
	{"PCM_1_PB_CH2", "ADDA_UL_CH6", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH1", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH2", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH3", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH4", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH5", "Hostless Speech DL"},
	{"PCM_1_PB_CH3", "ADDA_UL_CH6", "Hostless Speech DL"},
	...
	{"Hostless Speech UL", NULL, "ADDA_CH56_UL_Mux"},
	...
	{"I2SOUT5_CH1", "CONNSYS_I2S_CH1", "Hostless FM DL"},
	{"I2SOUT5_CH2", "CONNSYS_I2S_CH2", "Hostless FM DL"},
	{"I2SOUT4_CH3", "CONNSYS_I2S_CH1", "Hostless FM DL"},
	{"I2SOUT4_CH4", "CONNSYS_I2S_CH2", "Hostless FM DL"},
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6991_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_0_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_0_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_1_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_1_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_2_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_SRC_2_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_HW_GAIN_AAUDIO,
		.capture = {
	...
	},
	{
		...
		.id = MT6991_DAI_HOSTLESS_SRC_AAUDIO,
		.playback = {
