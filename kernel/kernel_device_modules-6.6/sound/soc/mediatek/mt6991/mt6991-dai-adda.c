...
static const struct snd_kcontrol_new mtk_adda_dl_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH1", AFE_CONN014_2, I_DL23_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN014_2, I_DL24_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH1", AFE_CONN014_2, I_DL25_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL26_CH1", AFE_CONN014_2, I_DL26_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH2", AFE_CONN015_1, I_DL_4CH_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH2", AFE_CONN015_1, I_DL_24CH_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH2", AFE_CONN015_2, I_DL23_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN015_2, I_DL24_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH2", AFE_CONN015_2, I_DL25_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL26_CH2", AFE_CONN015_2, I_DL26_CH2, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch3_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH1", AFE_CONN016_1, I_DL_4CH_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH3", AFE_CONN016_1, I_DL_4CH_CH3, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH1", AFE_CONN016_2, I_DL23_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN016_2, I_DL24_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH1", AFE_CONN016_2, I_DL25_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL26_CH1", AFE_CONN016_2, I_DL26_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch4_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL6_CH2", AFE_CONN017_1, I_DL6_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL7_CH2", AFE_CONN017_1, I_DL7_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL8_CH2", AFE_CONN017_1, I_DL8_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH2", AFE_CONN017_1, I_DL_4CH_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL_4CH_CH4", AFE_CONN017_1, I_DL_4CH_CH4, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH2", AFE_CONN017_2, I_DL23_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN017_2, I_DL24_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH2", AFE_CONN017_2, I_DL25_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL26_CH2", AFE_CONN017_2, I_DL26_CH2, 1, 0),
			     ...
			     int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_ADDA, 1);
				  ...
				  int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_ADDA_CH34, 1);
	...
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_ADDA_CH34, 1);
			     ...
			     int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_ADDA, 1);
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_AP_DMIC, 1);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_ADDA, 1);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_AP_DMIC, 1);
		break;
	default:
		break;
	}
				  ...
				  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_ADDA_CH34, 1);
		mt6991_afe_gpio_request(afe, true, MT6991_DAI_AP_DMIC_CH34, 1);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_ADDA_CH34, 1);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_AP_DMIC_CH34, 1);
		break;
	default:
		break;
	}
...
static bool is_adda_mtkaif_need_phase_delay(struct mt6991_afe_private *afe_priv)
{
	if (mt6991_afe_gpio_is_prepared(MT6991_AFE_GPIO_DAT_MISO0_ON) &&
	...
	if (mt6991_afe_gpio_is_prepared(MT6991_AFE_GPIO_DAT_MISO1_ON) &&
				  ...
				  int event)
{
	...
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6991_afe_gpio_request(afe, false, MT6991_DAI_ADDA_CH34, 0);
		break;
	default:
		break;
	}
...
/* mtkaif dmic */
static const char *const mt6991_adda_off_on_str[] = {
	"Off", "On"
};

static const struct soc_enum mt6991_adda_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6991_adda_off_on_str),
			    mt6991_adda_off_on_str),
};

static int mt6991_adda_ap_dmic_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda_ap_dmic_set(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda_dmic_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda_dmic_set(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda6_only_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda6_only_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda_dl_max_vol_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_adda_dl_max_vol_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_vow_enable_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6991_vow_enable_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_adda_controls[] = {
	...
	SOC_ENUM_EXT("MTKAIF_DMIC", mt6991_adda_enum[0],
		     mt6991_adda_dmic_get, mt6991_adda_dmic_set),
	SOC_ENUM_EXT("MTKAIF_ADDA6_ONLY", mt6991_adda_enum[0],
		     mt6991_adda6_only_get, mt6991_adda6_only_set),
	SOC_SINGLE_EXT("ADDA_DL_MAX_VOL",
		       SND_SOC_NOPM, 0, 0x1, 0,
		       mt6991_adda_dl_max_vol_get,
		       mt6991_adda_dl_max_vol_set),
	SOC_SINGLE_EXT("VOW_ENABLE",
		       SND_SOC_NOPM, 0, 0x1, 0,
		       mt6991_vow_enable_get,
...
static const struct snd_soc_dapm_route mtk_dai_adda_routes[] = {
	...
	{"ADDA_DL_CH1", "DL23_CH1", "DL23"},
	{"ADDA_DL_CH2", "DL23_CH2", "DL23"},

	{"ADDA_DL_CH1", "DL24_CH1", "DL24"},
	{"ADDA_DL_CH2", "DL24_CH2", "DL24"},

	{"ADDA_DL_CH1", "DL25_CH1", "DL25"},
	{"ADDA_DL_CH2", "DL25_CH2", "DL25"},

	{"ADDA_DL_CH1", "DL26_CH1", "DL26"},
	{"ADDA_DL_CH2", "DL26_CH2", "DL26"},
	...
	{"ADDA_DL_CH3", "DL_4CH_CH1", "DL_4CH"},
	{"ADDA_DL_CH4", "DL_4CH_CH2", "DL_4CH"},
	{"ADDA_DL_CH3", "DL_4CH_CH3", "DL_4CH"},
	{"ADDA_DL_CH4", "DL_4CH_CH4", "DL_4CH"},
	...
	{"ADDA_DL_CH3", "DL23_CH1", "DL23"},
	{"ADDA_DL_CH4", "DL23_CH2", "DL23"},

	{"ADDA_DL_CH3", "DL24_CH1", "DL24"},
	{"ADDA_DL_CH4", "DL24_CH2", "DL24"},

	{"ADDA_DL_CH3", "DL25_CH1", "DL25"},
	{"ADDA_DL_CH4", "DL25_CH2", "DL25"},

	{"ADDA_DL_CH3", "DL26_CH1", "DL26"},
	{"ADDA_DL_CH4", "DL26_CH2", "DL26"},
...
int mt6991_dai_adda_register(struct mtk_base_afe *afe)
{
	...
	/* set dai priv */
	ret = mt6991_dai_set_priv(afe, MT6991_DAI_ADDA,
				  sizeof(struct mtk_afe_adda_priv), NULL);
	if (ret)
		return ret;

	ret = mt6991_dai_set_priv(afe, MT6991_DAI_ADDA_CH34,
				  sizeof(struct mtk_afe_adda_priv), NULL);
	if (ret)
		return ret;

	ret = mt6991_dai_set_priv(afe, MT6991_DAI_ADDA_CH56,
				  sizeof(struct mtk_afe_adda_priv), NULL);
	if (ret)
		return ret;
	...
	afe_priv->dai_priv[MT6991_DAI_AP_DMIC] =
