...
#define MT6368_MAX_REGISTER MT6368_ZCD_CON8
...
/* AFE_UL_SRC_CON1 */
#define PMIC6368_DMIC_LOW_POWER_MODE_CTL_SFT                      6
#define PMIC6368_DMIC_LOW_POWER_MODE_CTL_MASK                     0x3
#define PMIC6368_DMIC_LOW_POWER_MODE_CTL_MASK_SFT                 (0x3 << 6)
#define DIGMIC_4P33M_SEL_CTL_SFT                         5
#define DIGMIC_4P33M_SEL_CTL_MASK                        0x1
#define DIGMIC_4P33M_SEL_CTL_MASK_SFT                    (0x1 << 5)
#define PMIC6368_DIGMIC_3P25M_1P625M_SEL_CTL_SFT                  4
#define PMIC6368_DIGMIC_3P25M_1P625M_SEL_CTL_MASK                 0x1
#define PMIC6368_DIGMIC_3P25M_1P625M_SEL_CTL_MASK_SFT             (0x1 << 4)
...
#define MTKAIFTX_V3_SDATA_OUT3_SFT                       6
#define MTKAIFTX_V3_SDATA_OUT3_MASK                      0x1
#define MTKAIFTX_V3_SDATA_OUT3_MASK_SFT                  (0x1 << 6)
...
/* AFE_SGEN_CFG0 */
#define PMIC6368_C_DAC_EN_CTL_SFT                                 7
#define PMIC6368_C_DAC_EN_CTL_MASK                                0x1
#define PMIC6368_C_DAC_EN_CTL_MASK_SFT                            (0x1 << 7)
#define PMIC6368_C_MUTE_SW_CTL_SFT                                6
#define PMIC6368_C_MUTE_SW_CTL_MASK                               0x1
#define PMIC6368_C_MUTE_SW_CTL_MASK_SFT                           (0x1 << 6)
...
/* AFE_SGEN_CFG1 */
#define PMIC6368_C_AMP_DIV_CH1_CTL_SFT                            0
#define PMIC6368_C_AMP_DIV_CH1_CTL_MASK                           0xf
#define PMIC6368_C_AMP_DIV_CH1_CTL_MASK_SFT                       (0xf << 0)
...
#define PMIC6368_C_FREQ_DIV_CH1_CTL_SFT                           0
#define PMIC6368_C_FREQ_DIV_CH1_CTL_MASK                          0x1f
#define PMIC6368_C_FREQ_DIV_CH1_CTL_MASK_SFT                      (0x1f << 0)
...
#define RG_BULKL_VCM_EN_SFT                              3
#define RG_BULKL_VCM_EN_MASK                             0x1
#define RG_BULKL_VCM_EN_MASK_SFT                         (0x1 << 3)
...
#define RG_BULKR_VCM_EN_SFT                              3
#define RG_BULKR_VCM_EN_MASK                             0x1
#define RG_BULKR_VCM_EN_MASK_SFT                         (0x1 << 3)
...
#define RG_AUDPREAMP3GAIN_MASK_SFT                       (0x7 << 0)
#define RG_BULK3_VCM_EN_SFT                              3
#define RG_BULK3_VCM_EN_MASK                             0x1
#define RG_BULK3_VCM_EN_MASK_SFT                         (0x1 << 3)
...
#define RG_AUDSPAREPGA_SFT                               3
#define RG_AUDSPAREPGA_MASK                              0x1f
#define RG_AUDSPAREPGA_MASK_SFT                          (0x1f << 3)
...
/* AUDENC_ANA_CON14 */
#define RG_AUDADCTESTDATA_L_SFT                          0
#define RG_AUDADCTESTDATA_L_MASK                         0xff
#define RG_AUDADCTESTDATA_L_MASK_SFT                     (0xff << 0)

/* AUDENC_ANA_CON15 */
#define RG_AUDADCTESTDATA_H_SFT                          0
#define RG_AUDADCTESTDATA_H_MASK                         0xff
#define RG_AUDADCTESTDATA_H_MASK_SFT                     (0xff << 0)
...
/* AUDENC_ANA_CON20 */
#define RG_AUD3SPARE_SFT                                 0
#define RG_AUD3SPARE_MASK                                0x1f
#define RG_AUD3SPARE_MASK_SFT                            (0x1f << 0)
...
#define RG_AUDENC_SPARE2_L_SFT                           3
#define RG_AUDENC_SPARE2_L_MASK                          0x1f
#define RG_AUDENC_SPARE2_L_MASK_SFT                      (0x1f << 3)

/* AUDENC_ANA_CON26 */
#define RG_AUDENC_SPARE2_H_SFT                           0
#define RG_AUDENC_SPARE2_H_MASK                          0xff
#define RG_AUDENC_SPARE2_H_MASK_SFT                      (0xff << 0)
...
/* AUDENC_ANA_CON36 */
#define RG_AUDMICBIAS2DCSW3P1EN_SFT                      0
#define RG_AUDMICBIAS2DCSW3P1EN_MASK                     0x1
#define RG_AUDMICBIAS2DCSW3P1EN_MASK_SFT                 (0x1 << 0)
#define RG_AUDMICBIAS2DCSW3P2EN_SFT                      1
#define RG_AUDMICBIAS2DCSW3P2EN_MASK                     0x1
#define RG_AUDMICBIAS2DCSW3P2EN_MASK_SFT                 (0x1 << 1)
#define RG_AUDMICBIAS2DCSW3NEN_SFT                       2
#define RG_AUDMICBIAS2DCSW3NEN_MASK                      0x1
#define RG_AUDMICBIAS2DCSW3NEN_MASK_SFT                  (0x1 << 2)
#define RG_AUDMICBIASSPARE_SFT                           4
#define RG_AUDMICBIASSPARE_MASK                          0xf
#define RG_AUDMICBIASSPARE_MASK_SFT                      (0xf << 4)
...
#define RG_EINT1CTURBO_SFT                               5
#define RG_EINT1CTURBO_MASK                              0x7
#define RG_EINT1CTURBO_MASK_SFT                          (0x7 << 5)
...
/* AUDENC_ANA_CON48 */
#define RG_SPARE_VOW_SFT                                 0
#define RG_SPARE_VOW_MASK                                0x7
#define RG_SPARE_VOW_MASK_SFT                            (0x7 << 0)
...
/* AUDDEC_ANA_CON1 */
#define RG_AUDHPLMUXINPUTSEL_VAUDP32_SFT                 0
#define RG_AUDHPLMUXINPUTSEL_VAUDP32_MASK                0x3
#define RG_AUDHPLMUXINPUTSEL_VAUDP32_MASK_SFT            (0x3 << 0)
#define RG_AUDHPRMUXINPUTSEL_VAUDP32_SFT                 2
#define RG_AUDHPRMUXINPUTSEL_VAUDP32_MASK                0x3
#define RG_AUDHPRMUXINPUTSEL_VAUDP32_MASK_SFT            (0x3 << 2)
#define RG_AUDHPLSCDISABLE_VAUDP32_SFT                   4
#define RG_AUDHPLSCDISABLE_VAUDP32_MASK                  0x1
#define RG_AUDHPLSCDISABLE_VAUDP32_MASK_SFT              (0x1 << 4)
#define RG_AUDHPRSCDISABLE_VAUDP32_SFT                   5
#define RG_AUDHPRSCDISABLE_VAUDP32_MASK                  0x1
#define RG_AUDHPRSCDISABLE_VAUDP32_MASK_SFT              (0x1 << 5)
#define RG_AUDHPLBSCCURRENT_VAUDP32_SFT                  6
#define RG_AUDHPLBSCCURRENT_VAUDP32_MASK                 0x1
#define RG_AUDHPLBSCCURRENT_VAUDP32_MASK_SFT             (0x1 << 6)
#define RG_AUDHPRBSCCURRENT_VAUDP32_SFT                  7
#define RG_AUDHPRBSCCURRENT_VAUDP32_MASK                 0x1
#define RG_AUDHPRBSCCURRENT_VAUDP32_MASK_SFT             (0x1 << 7)
...
/* AUDDEC_ANA_CON3 */
#define RG_HPLOUTSTGCTRL_VAUDP32_SFT                     0
#define RG_HPLOUTSTGCTRL_VAUDP32_MASK                    0x7
#define RG_HPLOUTSTGCTRL_VAUDP32_MASK_SFT                (0x7 << 0)
#define RG_HPROUTSTGCTRL_VAUDP32_SFT                     4
#define RG_HPROUTSTGCTRL_VAUDP32_MASK                    0x7
#define RG_HPROUTSTGCTRL_VAUDP32_MASK_SFT                (0x7 << 4)
...
/* AUDDEC_ANA_CON5 */
#define RG_AUDREFN_DERES_EN_VAUDP32_SFT                  0
#define RG_AUDREFN_DERES_EN_VAUDP32_MASK                 0x1
#define RG_AUDREFN_DERES_EN_VAUDP32_MASK_SFT             (0x1 << 0)
#define RG_HPINPUTSTBENH_VAUDP32_SFT                     1
#define RG_HPINPUTSTBENH_VAUDP32_MASK                    0x1
#define RG_HPINPUTSTBENH_VAUDP32_MASK_SFT                (0x1 << 1)
#define RG_HPINPUTRESET0_VAUDP32_SFT                     2
#define RG_HPINPUTRESET0_VAUDP32_MASK                    0x1
#define RG_HPINPUTRESET0_VAUDP32_MASK_SFT                (0x1 << 2)
#define RG_HPOUTPUTRESET0_VAUDP32_SFT                    3
#define RG_HPOUTPUTRESET0_VAUDP32_MASK                   0x1
#define RG_HPOUTPUTRESET0_VAUDP32_MASK_SFT               (0x1 << 3)
#define RG_HPPSHORT2VCM_VAUDP32_SFT                      4
#define RG_HPPSHORT2VCM_VAUDP32_MASK                     0x7
#define RG_HPPSHORT2VCM_VAUDP32_MASK_SFT                 (0x7 << 4)
#define RG_AUDHPTRIM_EN_VAUDP32_SFT                      7
#define RG_AUDHPTRIM_EN_VAUDP32_MASK                     0x1
#define RG_AUDHPTRIM_EN_VAUDP32_MASK_SFT                 (0x1 << 7)

/* AUDDEC_ANA_CON6 */
#define RG_AUDHPLFINETRIM_VAUDP32_SFT                    0
#define RG_AUDHPLFINETRIM_VAUDP32_MASK                   0x7
#define RG_AUDHPLFINETRIM_VAUDP32_MASK_SFT               (0x7 << 0)
#define RG_AUDHPLTRIM_VAUDP32_SFT                        3
#define RG_AUDHPLTRIM_VAUDP32_MASK                       0x1f
#define RG_AUDHPLTRIM_VAUDP32_MASK_SFT                   (0x1f << 3)

/* AUDDEC_ANA_CON7 */
#define RG_AUDHPRFINETRIM_VAUDP32_SFT                    0
#define RG_AUDHPRFINETRIM_VAUDP32_MASK                   0x7
#define RG_AUDHPRFINETRIM_VAUDP32_MASK_SFT               (0x7 << 0)
#define RG_AUDHPRTRIM_VAUDP32_SFT                        3
#define RG_AUDHPRTRIM_VAUDP32_MASK                       0x1f
#define RG_AUDHPRTRIM_VAUDP32_MASK_SFT                   (0x1f << 3)
...
/* AUDDEC_ANA_CON9 */
#define RG_AUDHPHFCOMPRESSEL_VAUDP32_SFT                 0
#define RG_AUDHPHFCOMPRESSEL_VAUDP32_MASK                0x7
#define RG_AUDHPHFCOMPRESSEL_VAUDP32_MASK_SFT            (0x7 << 0)
#define RG_AUDHPHFCOMPBUFGAINSEL_VAUDP32_SFT             4
#define RG_AUDHPHFCOMPBUFGAINSEL_VAUDP32_MASK            0x3
#define RG_AUDHPHFCOMPBUFGAINSEL_VAUDP32_MASK_SFT        (0x3 << 4)
#define RG_AUDHPCOMP_EN_VAUDP32_SFT                      7
#define RG_AUDHPCOMP_EN_VAUDP32_MASK                     0x1
#define RG_AUDHPCOMP_EN_VAUDP32_MASK_SFT                 (0x1 << 7)
...
/* AUDDEC_ANA_CON12 */
#define RG_HSINPUTSTBENH_VAUDP32_SFT                     0
#define RG_HSINPUTSTBENH_VAUDP32_MASK                    0x1
#define RG_HSINPUTSTBENH_VAUDP32_MASK_SFT                (0x1 << 0)
#define RG_HSINPUTRESET0_VAUDP32_SFT                     1
#define RG_HSINPUTRESET0_VAUDP32_MASK                    0x1
#define RG_HSINPUTRESET0_VAUDP32_MASK_SFT                (0x1 << 1)
#define RG_HSOUTPUTRESET0_VAUDP32_SFT                    2
#define RG_HSOUTPUTRESET0_VAUDP32_MASK                   0x1
#define RG_HSOUTPUTRESET0_VAUDP32_MASK_SFT               (0x1 << 2)
#define RG_HSOUT_SHORTVCM_VAUDP32_SFT                    3
#define RG_HSOUT_SHORTVCM_VAUDP32_MASK                   0x1
#define RG_HSOUT_SHORTVCM_VAUDP32_MASK_SFT               (0x1 << 3)
...
/* AUDDEC_ANA_CON14 */
#define RG_LOOUTPUTSTBENH_VAUDP32_SFT                    0
#define RG_LOOUTPUTSTBENH_VAUDP32_MASK                   0x1
#define RG_LOOUTPUTSTBENH_VAUDP32_MASK_SFT               (0x1 << 0)
#define RG_LOINPUTRESET0_VAUDP32_SFT                     1
#define RG_LOINPUTRESET0_VAUDP32_MASK                    0x1
#define RG_LOINPUTRESET0_VAUDP32_MASK_SFT                (0x1 << 1)
#define RG_LOOUTPUTRESET0_VAUDP32_SFT                    2
#define RG_LOOUTPUTRESET0_VAUDP32_MASK                   0x1
#define RG_LOOUTPUTRESET0_VAUDP32_MASK_SFT               (0x1 << 2)
#define RG_LOOUT_SHORTVCM_VAUDP32_SFT                    3
#define RG_LOOUT_SHORTVCM_VAUDP32_MASK                   0x1
#define RG_LOOUT_SHORTVCM_VAUDP32_MASK_SFT               (0x1 << 3)

/* AUDDEC_ANA_CON15 */
#define RG_AUDDACTPWRUP_VAUDP32_SFT                      0
#define RG_AUDDACTPWRUP_VAUDP32_MASK                     0x1
#define RG_AUDDACTPWRUP_VAUDP32_MASK_SFT                 (0x1 << 0)
#define RG_AUD_DAC_PWT_UP_VA32_SFT                       1
#define RG_AUD_DAC_PWT_UP_VA32_MASK                      0x1
#define RG_AUD_DAC_PWT_UP_VA32_MASK_SFT                  (0x1 << 1)
...
/* AUDDEC_ANA_CON17 */
#define RG_AUDHPSPKDET_INPUTMUXSEL_VAUDP32_SFT           0
#define RG_AUDHPSPKDET_INPUTMUXSEL_VAUDP32_MASK          0x3
#define RG_AUDHPSPKDET_INPUTMUXSEL_VAUDP32_MASK_SFT      (0x3 << 0)
#define RG_AUDHPSPKDET_OUTPUTMUXSEL_VAUDP32_SFT          2
#define RG_AUDHPSPKDET_OUTPUTMUXSEL_VAUDP32_MASK         0x3
#define RG_AUDHPSPKDET_OUTPUTMUXSEL_VAUDP32_MASK_SFT     (0x3 << 2)
#define RG_AUDHPSPKDET_EN_VAUDP32_SFT                    4
#define RG_AUDHPSPKDET_EN_VAUDP32_MASK                   0x1
#define RG_AUDHPSPKDET_EN_VAUDP32_MASK_SFT               (0x1 << 4)
...
/* AUDDEC_ANA_CON19 */
#define RG_ABIDEC_RSVD0_VAUDP32_SFT                      0
#define RG_ABIDEC_RSVD0_VAUDP32_MASK                     0xff
#define RG_ABIDEC_RSVD0_VAUDP32_MASK_SFT                 (0xff << 0)
...
/* AUDDEC_ANA_CON21 */
#define RG_ABIDEC_RSVD2_VAUDP32_SFT                      0
#define RG_ABIDEC_RSVD2_VAUDP32_MASK                     0xff
#define RG_ABIDEC_RSVD2_VAUDP32_MASK_SFT                 (0xff << 0)
...
/* AUDDEC_ANA_CON23 */
#define RG_AUDBIASADJ_0_HP_VAUDP32_SFT                   0
#define RG_AUDBIASADJ_0_HP_VAUDP32_MASK                  0x7
#define RG_AUDBIASADJ_0_HP_VAUDP32_MASK_SFT              (0x7 << 0)
#define RG_AUDBIASADJ_0_HS_VAUDP32_SFT                   4
#define RG_AUDBIASADJ_0_HS_VAUDP32_MASK                  0x7
#define RG_AUDBIASADJ_0_HS_VAUDP32_MASK_SFT              (0x7 << 4)

/* AUDDEC_ANA_CON24 */
#define RG_AUDBIASADJ_0_LO_VAUDP32_SFT                   0
#define RG_AUDBIASADJ_0_LO_VAUDP32_MASK                  0x7
#define RG_AUDBIASADJ_0_LO_VAUDP32_MASK_SFT              (0x7 << 0)
#define RG_AUDIBIASPWRDN_VAUDP32_SFT                     4
#define RG_AUDIBIASPWRDN_VAUDP32_MASK                    0x1
#define RG_AUDIBIASPWRDN_VAUDP32_MASK_SFT                (0x1 << 4)
...
/* AUDDEC_ANA_CON28 */
#define RG_AUDPMU_RSVD_VA18_SFT                          0
#define RG_AUDPMU_RSVD_VA18_MASK                         0xff
#define RG_AUDPMU_RSVD_VA18_MASK_SFT                     (0xff << 0)
...
#define RG_ACCDET_RST_ADDR                            \
	MT6368_AUD_TOP_RST_CON0
#define RG_ACCDET_RST_SFT                             1
#define RG_ACCDET_RST_MASK                            0x1
#define RG_ACCDET_RST_MASK_SFT                        (0x1 << 1)
#define BANK_ACCDET_SWRST_ADDR                        \
	MT6368_AUD_TOP_RST_BANK_CON0
#define BANK_ACCDET_SWRST_SFT                         0
#define BANK_ACCDET_SWRST_MASK                        0x1
#define BANK_ACCDET_SWRST_MASK_SFT                    (0x1 << 0)

#define RG_INT_EN_ACCDET_ADDR                         \
	MT6368_AUD_TOP_INT_CON0
#define RG_INT_EN_ACCDET_SFT                          1
#define RG_INT_EN_ACCDET_MASK                         0x1
#define RG_INT_EN_ACCDET_MASK_SFT                     (0x1 << 1)
...
#define RG_INT_RAW_STATUS_ACCDET_ADDR                 \
	MT6368_AUD_TOP_INT_RAW_STATUS0
#define RG_INT_RAW_STATUS_ACCDET_SFT                  1
#define RG_INT_RAW_STATUS_ACCDET_MASK                 0x1
#define RG_INT_RAW_STATUS_ACCDET_MASK_SFT             (0x1 << 1)
...
#define AUD_TOP_ANA_ID_ADDR                           \
	MT6368_AUD_TOP_ANA_ID
#define RG_AUDMICBIAS1HVEN_ADDR                       \
	MT6368_AUDENC_ANA_CON34
#define RG_AUDMICBIAS1HVEN_SFT                        4
#define RG_AUDMICBIAS1HVEN_MASK                       0x1
#define RG_AUDMICBIAS1HVEN_MASK_SFT                   (0x1 << 4)
...
#define RG_RTC32K_CK_PDN_ADDR                         \
	MT6368_TOP_CKPDN_CON0
#define RG_RTC32K_CK_PDN_SFT                          7
#define RG_RTC32K_CK_PDN_MASK                         0x1
#define RG_RTC32K_CK_PDN_MASK_SFT                     (0x1 << 7)
#define RG_HPLOUTPUTSTBENH_VAUDP32_ADDR               \
	MT6368_AUDDEC_ANA_CON4
#define RG_HPLOUTPUTSTBENH_VAUDP32_SFT                0
#define RG_HPLOUTPUTSTBENH_VAUDP32_MASK               0x7
#define RG_HPLOUTPUTSTBENH_VAUDP32_MASK_SFT           (0x7 << 0)
...
enum {
	MT6368_MTKAIF_PROTOCOL_1 = 0,
	MT6368_MTKAIF_PROTOCOL_2,
	MT6368_MTKAIF_PROTOCOL_2_CLK_P2,
};

enum {
	MT6368_AIF_1 = 0,       /* dl: hp, rcv, hp+lo */
	MT6368_AIF_2,           /* dl: lo only */
	MT6368_AIF_VOW,
	MT6368_AIF_NUM,
};
...
struct mt6368_vow_periodic_on_off_data {
...
struct mt6368_priv {
	...
	unsigned int dl_rate[MT6368_AIF_NUM];
	unsigned int ul_rate[MT6368_AIF_NUM];
...
#define DRBIAS_HP_SFT (RG_AUDBIASADJ_0_HP_VAUDP32_SFT)
#define DRBIAS_HP_MASK_SFT (DRBIAS_MASK << DRBIAS_HP_SFT)
#define DRBIAS_HS_SFT (RG_AUDBIASADJ_0_HS_VAUDP32_SFT)
#define DRBIAS_HS_MASK_SFT (DRBIAS_MASK << DRBIAS_HS_SFT)
#define DRBIAS_LO_SFT (RG_AUDBIASADJ_0_LO_VAUDP32_SFT)
...
/* codec name */
#define CODEC_MT6368_NAME "mtk-codec-mt6368"
#define DEVICE_MT6368_NAME "mt6368-sound"
