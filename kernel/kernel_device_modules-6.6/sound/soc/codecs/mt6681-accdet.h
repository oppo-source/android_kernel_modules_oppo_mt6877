 ...
 * Author: Shang-ming.huang <shang-ming.huang@mediatek.com>
 */
...
struct head_dts_data {
	...
	unsigned int mic_gnd_swap_enable;
	unsigned int mic_gnd_swap_delay;
#endif
...
extern void mt6681_accdet_modify_vref_volt(void);
extern int mt6681_accdet_init(struct snd_soc_component *component, struct snd_soc_card *card);
#endif
