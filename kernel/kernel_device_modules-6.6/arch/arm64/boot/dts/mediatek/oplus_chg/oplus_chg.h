...
#define OPLUS_IC_VIRQ_FPGA_RST		22
#define OPLUS_IC_VIRQ_PD_COMPLETED	23
#define OPLUS_IC_VIRQ_PD_RX		24
...
#define OPLUS_IC_FUNC_GAUGE_GET_VCT			(OPLUS_IC_FUNC_NUM_GAUGE_START + 95)
#define OPLUS_IC_FUNC_GAUGE_SET_VCT			(OPLUS_IC_FUNC_NUM_GAUGE_START + 96)
#define OPLUS_IC_FUNC_GAUGE_SET_CUV_STATE		(OPLUS_IC_FUNC_NUM_GAUGE_START + 97)
#define OPLUS_IC_FUNC_GAUGE_GET_CUV_STATE		(OPLUS_IC_FUNC_NUM_GAUGE_START + 98)
#define OPLUS_IC_FUNC_GAUGE_GET_GAUGE_R_INFO		(OPLUS_IC_FUNC_NUM_GAUGE_START + 99)
...
#define OPLUS_IC_FUNC_GAUGE_GET_THREE_LEVEL_TERM_VOLT	(OPLUS_IC_FUNC_NUM_GAUGE2_START + 4)
#define OPLUS_IC_FUNC_GAUGE_SET_THREE_LEVEL_TERM_VOLT	(OPLUS_IC_FUNC_NUM_GAUGE2_START + 5)
#define OPLUS_IC_FUNC_GAUGE_GET_FCL_VOLT		(OPLUS_IC_FUNC_NUM_GAUGE2_START + 6)
#define OPLUS_IC_FUNC_GAUGE_GET_BATT_SOC_CENTI		(OPLUS_IC_FUNC_NUM_GAUGE2_START + 7)
