...
COMMON_OPLUS_MODULES_LIST = [
    ...
    "//vendor/oplus/kernel/mm:oplus_bsp_fg_protect",
    "//vendor/oplus/kernel/mm:oplus_bsp_level_protect",
    ...
    "//vendor/oplus/kernel/storage/storage_feature_in_module/common/iolimit:iolimit",
    "//vendor/oplus/kernel/storage/storage_feature_in_module/common/io_monitor:oplus_io_monitor",
]
...
def get_overlay_modules_list():
    ...
    if "oplus6991.config" in DEFCONFIG_OVERLAYS:
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/camera:oplus_camera_al9800a_25922")
        COMMON_OPLUS_MODULES_LIST.append("//vendor/oplus/kernel/wifi:oplus_wifi_swtp")
